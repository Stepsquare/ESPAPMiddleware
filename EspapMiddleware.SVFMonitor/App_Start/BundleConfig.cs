    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/Styles/css")
                .Include("~/Content/lib/font-awesome/css/all.min.css", new CssRewriteUrlTransform())
                .Include("~/Content/lib/bootstrap/dist/css/bootstrap.min.css")
                .Include("~/Content/lib/kendo-ui/styles/kendo.common-nova.min.css", new CssRewriteUrlTransform())
                .Include("~/Content/lib/kendo-ui/styles/kendo.material.min.css", new CssRewriteUrlTransform())
